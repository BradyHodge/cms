...
export const MOCKDOCUMENTS: Document[] = [
  ...
  },
  {
    ...
    children: [
      {id: '12', name: 'Case 1 – Defining the requirements', description: null, url: 'https://rkjackson.wordpress.com/cases/case-1/', children: null},
      {id: '13', name: 'Case 2 – User Interface design', description: null, url: 'https://rkjackson.wordpress.com/cases/case-2/', children: null},
      {
        id: '14', name: 'Case 3 – Implementing Model Layer', description: null, url: 'https://rkjackson.wordpress.com/cases/case-3/',
        children: [
      ...
      {id: '15', name: 'Case 4 – Enterprise Java Session Beans', description: null, url: 'https://rkjackson.wordpress.com/cases/case-4/', children: null},
      {id: '16', name: 'Case 5 – Implementing the View', description: null, url: 'https://rkjackson.wordpress.com/cases/case-5/', children: null},
      {id: '17', name: 'Case 6 – A Framework for the View Layer', description: null, url: 'https://rkjackson.wordpress.com/cases/case-6/', children: null}
    ]
  },
  {
    id: '20',
